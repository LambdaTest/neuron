...
func newZapLogger(config *LoggingConfig, verbose bool) Logger {
	...
	// AddCallerSkip skips  callDepth number of callers, this is important else the file that gets
...
// we append the magic string for warn, fatal and error logs for sumologic monitoring
...
func (l *zapLogger) Warnf(format string, args ...interface{}) {
	format += fmt.Sprintf(" %s", l.cfg.MagicString)
...
func (l *zapLogger) WithFields(fields Fields) Logger {
	...
	return &zapLogger{newLogger, l.cfg}
}
